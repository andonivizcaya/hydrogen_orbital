...
release-wasm: main.c hydrogen.h
	emcc -O3 -o ./wasm/index.html main.c -Os -Wall ./thirdparty/raylib-5.5_webassembly/lib/libraylib.a -I./thirdparty/include  -L./thirdparty/raylib-5.5_webassembly/lib -s USE_GLFW=3 -DPLATFORM_WEB -DWEB_RELEASE -s ALLOW_MEMORY_GROWTH=1 -DGRAPHICS_API_OPENGL_ES2 -s FORCE_FILESYSTEM=1 --preload-file resources/fonts/Iosevka-Regular.ttc --shell-file ./wasm/shell.html
